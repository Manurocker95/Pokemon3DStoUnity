                ...
                switch (MagicNum)
                {
                    ...
                    case GFMotionConstant:
                        ...
                        for (var Index = 0; Index < Header.Entries.Length; Index++)
                        {
                            ...
                            if (P3DS2UConfig.GetRenameGeneratedAnimationFiles())
                            {
                                string motionUsage = "";
                                ...
                                var anim = AnimationNaming.animationNames[motionUsage][Index];
                                bool needToImport = P3DS2UConfig.NeedToImportBasedOnAnimationImportOptions(animFilesCount, anim);
                                if (needToImport)
                                {
                                    if (SklAnim != null)
                                    {
